...
public class RakBuah implements RakIterator {
    ...
    public RakBuah(String id, String name, int spaceCount, int spaceCapacity){
        this.id = id;
        this.name = name;
